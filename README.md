...
Feed The Beast Stoneblock 2 modpack
made by Feed The Beast at https://feed-the-beast.com

NOTE: World reset is required when upgrading from v1/v2 to v3.0.1 or higher.

Modpack for Minecraft 1.12.2.
Stoneblock 2 is a general all-purpose pack that is designed for solo play as well as small and medium population servers.
...
<img src="https://apps.modpacks.ch/modpacks/art/7/Stoneblock 2.png" width="338" height="338">
...
Running ftb-Stoneblock 2 data container:
<code>docker run --name [name of your data container] alexcote1/ftb-Stoneblock 2 echo 'Data-only container'</code>

Running ftb-Stoneblock 2 server:
<code>docker run --tty=true --interactive=true --detach=true --name [name of your container] --volumes-from [name of your data container] --publish=[port on your host]:25565 alexcote1/ftb-Stoneblock 2</code>
