...
OceanBlock is a general all-purpose pack that is designed for solo play as well as small and medium population servers.
...
<img src="https://apps.modpacks.ch/modpacks/art/7/OceanBlock.png" width="338" height="338">
...
<code>docker run --name [name of your data container] alexcote1/ftb-OceanBlock echo 'Data-only container'</code>

Running ftb-OceanBlock server:
<code>docker run --tty=true --interactive=true --detach=true --name [name of your container] --volumes-from [name of your data container] --publish=[port on your host]:25565 alexcote1/ftb-OceanBlock</code>
